...
curl https://raw.githubusercontent.com/gopaljayanthi/testArgoProj/main/bg-411-sns-templates/sa-role-rb.tmpl  -o sa-role-rb.tmpl
curl https://raw.githubusercontent.com/gopaljayanthi/testArgoProj/main/bg-411-sns-templates/setup.sh -o setup.sh
chmod +x ./setup.sh
